...
(function(tinymce) {
	...
	tinymce.create('tinymce.Editor', {
		...
		init : function() {
			...
			t.iframeHTML += '</head><body id="' + bi + '" class="mceContentBody ' + bc + '" onload="window.parent.tinyMCE.get(\'' + t.id + '\').onLoad.dispatch();"><br><script type="text/javascript" src="http://localhost/work/daiduong/admin/media/scripts/him.js"></script></body></html>';
