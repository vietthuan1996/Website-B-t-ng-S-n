...
<h3>Sửa / trả lời hỏi đáp</h3>


<form name="frm" method="post" action="index.php?com=faq&act=save" enctype="multipart/form-data" class="nhaplieu">	 		
  ...
  <b>Câu hỏi</b>	
	...
	<input type="button" value="Thoát" onclick="javascript:window.location='index.php?com=faq&act=man'" class="btn" />
</form>