...
<form name="frm" method="post" action="index.php?com=product&act=save_list_photo&id=<?=$_REQUEST['id'];?>&idc=<?=$_REQUEST['idc']?>" enctype="multipart/form-data" class="nhaplieu">
...
<b>Số thứ tự </b> <input type="text" name="stt" value="<?=$item['stt']?>" style="width:30px" />	<br />
	...
	<input type="button" value="Thoát" onclick="javascript:window.location='index.php?com=product&act=man_list_photo'" class="btn" />
</form>