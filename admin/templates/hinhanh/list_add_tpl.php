...
<form name="frm" method="post" action="index.php?com=img&act=save_list" enctype="multipart/form-data" class="nhaplieu">	    
	...
	<input type="button" value="Thoát" onclick="javascript:window.location='index.php?com=img&act=man_list'" class="btn" />
</form>