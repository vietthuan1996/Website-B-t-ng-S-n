<h3><a href="index.php?com=hinhanh&act=add_photo&idc=<?=$_REQUEST['idc'];?>">Thêm hình ảnh</a></h3>
...
<a href="index.php?com=hinhanh&act=add_photo&idc=<?=$_REQUEST['idc'];?>"><img src="media/images/add.jpg" border="0"  /></a>
